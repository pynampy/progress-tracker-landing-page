      ...
      <div className='md:flex items-center'>
        <div className='md:w-[478px]'>
          ...
          <p className="text-xl text-[#010D3E] tracking-tight mt-6">
            Celebrate the joy of accomplishment with an app designed to trace your progress, motivate your efforts and celebrate your success
          </p>
          <div className="flex gap-1 items-center mt-[30px]">
            <button className="btn btn-primaty">Get for Free </button>
        ...
        <div className='mt-20 md:mt-0 md:h-[648px] md:flex-1 relative'>
          ...
          <Image src={cylinderImage} alt='cylinder' width={220} height={220}
            className='hidden md:block -top-8 -left-32 md:absolute'
          />
          <Image src={noodleImage} alt="noofle" width={220} className="hidden lg:block  absolute top-[524px] left-[448px] rotate-[30deg]" />
        </div>
